  ...
  useLayoutEffect(() => {
    ...
    const restoreMotionStyles = () => {
      const resetTargets = root.querySelectorAll<HTMLElement>([
        ...
        ".about-motion .bridge-core", ".about-motion .bridge-core .core-orbit", ".about-motion .about-copy", ".about-motion .about-visual-node",
